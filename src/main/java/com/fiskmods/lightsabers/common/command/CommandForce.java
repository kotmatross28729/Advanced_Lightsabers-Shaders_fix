        ...
        if (args.length > 0) {
            ...
            if (func.equals("xp") || func.equals("base")) {
                if (func.equals("base") && arg.equals("reset") && (args.length == 2 || args.length == 3)) {
                    ...
                    if (ALData.BASE_POWER.set(player, ALHelper.getBasePower(player))) {
                        func_152373_a(
                            sender,
                            this,
                            String.format("commands.force.%s.%s.success", func, arg),
                ...
                if (args.length == 3 || args.length == 4) {
                    ...
                    List translationKeys = arg.equals("set")
                        ? Lists.newArrayList(player.getCommandSenderName(), MathHelper.floor_float(amount))
                        : Lists.newArrayList(MathHelper.floor_float(amount), player.getCommandSenderName());
                    ...
                    if (arg.equals("give")) {
                        if (targetAll) {
                            ...
                            func_152373_a(
                                sender,
                                this,
                                "commands.force.power.give.success.all",
                                player.getCommandSenderName());
                        } else {
                            if (!PowerManager.unlockPower(player, power)) {
                                ...
                                func_152373_a(
                                    sender,
                                    this,
                                    "commands.force.power.give.success.one",
                                    player.getCommandSenderName(),
                                    power.getChatFormattedName());
                            }
                        }
                        ...
                        if (targetAll) {
                            ...
                            func_152373_a(
                                sender,
                                this,
                                "commands.force.power.take.success.all",
                                player.getCommandSenderName());
                        } else {
                            if (!PowerManager.removePower(player, power)) {
                                ...
                                func_152373_a(
                                    sender,
                                    this,
                                    "commands.force.power.take.success.one",
                                    power.getChatFormattedName(),
                                    player.getCommandSenderName());
                            }
                        }
                ...
                if (sender.canCommandSenderUseCommand(3, getCommandName())) {
                    if (arg.equals("locate") ? (args.length == 4 || args.length == 6)
                        ...
                        if (arg.equals("locate") ? args.length == 6 : args.length == 5) {
                            x = MathHelper
                                .floor_double(func_110666_a(sender, x, arg.equals("locate") ? args[4] : args[3]));
                            z = MathHelper
                                .floor_double(func_110666_a(sender, z, arg.equals("locate") ? args[5] : args[4]));
                        }
                        ...
                        if (arg.equals("locate")) {
                            ...
                            new Thread(
                                new StructureLocator(
                                    ...
                                    structure,
                                    targetAll,
                                    parseIntWithMin(sender, args[3], 0),
                                    x,
                                    z)).start();
                            return;
                            ...
                            try {
                                ...
                                func_152373_a(
                                    sender,
                                    this,
                                    "commands.force.structure.generate.success",
                                    ALHelper.getUnconventionalName(structure.name()),
                                    x,
                                    z);
