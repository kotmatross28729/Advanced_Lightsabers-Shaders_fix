...
public class BlockHolocron extends BlockContainer {
    ...
    private String[][] iconNames = {
        { "jedi_holocron_side", "jedi_holocron_corner", "jedi_holocron_corner_bottom", "jedi_holocron_corner_side" },
        { "sith_holocron_bottom", "sith_holocron_side" } };
            ...
            if (tile != null) {
                if (world.isRemote) {
                    ALNetworkManager.wrapper
                        .sendToServer(new PacketTileAction(player, tile.xCoord, tile.yCoord, tile.zCoord, 0));
                }
