...
public class BlockModSlab extends BlockSlab {
    ...
    public IIcon getIcon(int side, int metadata) {
        ...
        return k == 0 ? ModBlocks.lightForcestone.getBlockTextureFromSide(side)
            : ModBlocks.darkForcestone.getBlockTextureFromSide(side);
    }
    ...
    public boolean shouldSideBeRendered(IBlockAccess p_149646_1_, int p_149646_2_, int p_149646_3_, int p_149646_4_,
        ...
        if (field_150004_a) {
            ...
            && !super.shouldSideBeRendered(p_149646_1_, p_149646_2_, p_149646_3_, p_149646_4_, p_149646_5_)) {
                ...
                return flag ? (p_149646_5_ == 0 ? true
                    : (p_149646_5_ == 1
                        && super.shouldSideBeRendered(p_149646_1_, p_149646_2_, p_149646_3_, p_149646_4_, p_149646_5_)
                            ? true
                    ...
                    : (p_149646_5_ == 1 ? true
                        : (p_149646_5_ == 0 && super.shouldSideBeRendered(
                            p_149646_1_,
                            p_149646_2_,
                            p_149646_3_,
                            p_149646_4_,
