...
public class ModBlocks {
    ...
    public static void register() {
        ...
        lightForcestone = new BlockForcestone().setHardness(3.0F)
            .setResistance(100.0F);
        lightActivatedForcestone = new BlockPillar().setLightLevel(1.0F)
            .setHardness(3.0F)
            .setResistance(100.0F);
        lightForcestoneStairs = new BlockModStairs(lightForcestone, 0);
        darkForcestone = new BlockForcestone().setHardness(3.0F)
            .setResistance(100.0F);
        darkActivatedForcestone = new BlockPillar().setLightLevel(1.0F)
            .setHardness(3.0F)
            .setResistance(100.0F);
        darkForcestoneStairs = new BlockModStairs(darkForcestone, 0);
        forcestoneDoubleSlab = (BlockSlab) new BlockModSlab(true).setHardness(3.0F)
            .setResistance(100.0F);
        forcestoneSlab = (BlockSlab) new BlockModSlab(false).setHardness(3.0F)
            .setResistance(100.0F);
        ...
        BlockRegistry.registerItemBlockAsTileEntity(
            lightsaberCrystal,
            "Lightsaber Crystal",
        ...
        BlockRegistry.registerItemBlockAsTileEntity(
            ...
            "Lightsaber Forge Light",
            TileEntityLightsaberForge.class,
            ItemLightsaberForge.class);
        BlockRegistry.registerItemBlockAsTileEntity(
            lightsaberForgeDark,
            "Lightsaber Forge Dark",
            TileEntityLightsaberForge.class,
            ItemLightsaberForge.class);
        ...
        BlockRegistry.registerItemBlockAsTileEntity(
            disassemblyStation,
            "Disassembly Station",
            TileEntityDisassemblyStation.class,
            ItemDisassemblyTable.class);
        BlockRegistry
            .registerItemBlockAsTileEntity(sithCoffin, "Sith Coffin", TileEntitySithCoffin.class, ItemSithCoffin.class);
        BlockRegistry.registerItemBlockAsTileEntity(
            sithStoneCoffin,
            "Sith Stone Coffin",
            TileEntitySithStoneCoffin.class,
            ItemSithStoneCoffin.class);
        ...
        BlockRegistry.registerItemBlock(
            forcestoneDoubleSlab,
            "Forcestone Double Slab",
            new ItemSlab(forcestoneDoubleSlab, forcestoneSlab, forcestoneDoubleSlab, true));
        BlockRegistry.registerItemBlock(
            forcestoneSlab,
            "Forcestone Slab",
            new ItemSlab(forcestoneSlab, forcestoneSlab, forcestoneDoubleSlab, false));
