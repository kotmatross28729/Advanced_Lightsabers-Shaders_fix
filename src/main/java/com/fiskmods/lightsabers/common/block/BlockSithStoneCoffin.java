...
public class BlockSithStoneCoffin extends BlockContainer {
    ...
    public static EntitySithGhost spawnSithGhost(World world, int x, int y, int z) {
        ...
        entity.ticksExisted = -entity.getRNG()
            .nextInt(20);
            ...
            if (tile != null) {
                if (!tile.baseplateOnly && tile.taskFinished) {
                    world.playAuxSFX(
                        ...
                        y,
                        z,
                        Block.getIdFromBlock(world.getBlock(x, y, z)) + (world.getBlockMetadata(x, y, z) << 12));
                    world.setBlockToAir(x, y, z);
                    ...
                    if (tile.equipment != null) {
                        ...
                        itemstack.getTagCompound()
                            .setTag("Equipment", nbttagcompound);
                    }
    ...
    public void addBox(float minX, float minY, float minZ, float maxX, float maxY, float maxZ, World world, int x,
        int y, int z, AxisAlignedBB aabb, List list, Entity entity) {
