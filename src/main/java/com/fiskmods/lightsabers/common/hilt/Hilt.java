...
public abstract class Hilt extends FiskRegistryEntry<Hilt> {
    ...
    public static final FiskRegistryNamespaced<Hilt> REGISTRY = new FiskRegistryNamespaced(Lightsabers.MODID, "graflex")
        .setMaxId(MAX_ID);
    ...
    public final LightsaberData createDefault() {
        return new LightsaberData().set(this)
            .set(getColor())
            .set(getFocusingCrystals().toArray(new FocusingCrystal[0]));
    }
