...
public class ALDamageSources {
    ...
    public static final DamageSource INTO_WALL = new FiskDamageSource(Lightsabers.MODID, "intoWall")
        .with(DamageType.KINETIC)
        .setDamageBypassesArmor();

    public static DamageSource causeLightsaberDamage(Entity entity) {
        return new FiskEntityDamageSource(Lightsabers.MODID, "lightsaber", entity)
            .with(ALDamageTypes.LIGHTSABER, DamageType.ENERGY);
    }

    public static DamageSource causeForceDamage(Entity entity) {
        return new FiskEntityDamageSource(Lightsabers.MODID, "force", entity).with(ALDamageTypes.FORCE)
            .setMagicDamage()
            .setDamageBypassesArmor();
    }

    public static DamageSource causeForceLightningDamage(Entity entity) {
        return new FiskEntityDamageSource(Lightsabers.MODID, "lightning", entity)
            .with(ALDamageTypes.FORCE, DamageType.LIGHTNING)
            .setMagicDamage();
    }
}
