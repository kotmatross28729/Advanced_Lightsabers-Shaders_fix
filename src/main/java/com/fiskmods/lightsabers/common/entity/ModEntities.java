...
public class ModEntities {
    ...
    private static void registerEntity(Class<? extends Entity> entityClass, String name, int trackingRange,
        ...
        EntityRegistry.registerModEntity(
            ...
            name,
            ++nextID,
            Lightsabers.instance,
            trackingRange,
            updateFrequency,
            sendVelocityUpdates);
    }

    private static void registerEntityWithEgg(Class<? extends Entity> entityClass, String name, int trackingRange,
        int updateFrequency, boolean sendVelocityUpdates, int primary, int secondary) {
        EntityRegistry.registerGlobalEntityID(
            entityClass,
            Lightsabers.MODID + "." + name,
