    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int slot, boolean inHand) {
        if (!world.isRemote) {
            if (!itemstack.hasTagCompound() || !itemstack.getTagCompound()
                .hasKey(ALConstants.TAG_POUCH_UUID, NBT.TAG_STRING)) {
    ...
    public static UUID getUUID(ItemStack stack) {
        ...
        if (!stack.getTagCompound()
            ...
            stack.getTagCompound()
                .setString(ALConstants.TAG_POUCH_UUID, uuid.toString());
        ...
        return UUID.fromString(
            stack.getTagCompound()
                .getString(ALConstants.TAG_POUCH_UUID));
    }
}
