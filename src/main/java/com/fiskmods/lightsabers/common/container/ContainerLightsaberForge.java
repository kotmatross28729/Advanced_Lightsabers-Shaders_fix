...
public class ContainerLightsaberForge extends ContainerBasic<TileEntityLightsaberForge> {
    ...
    public static final int[][] SLOTS = { { 20, 17 }, { 20, 35 }, { 20, 53 }, { 20, 71 }, { 43, 71 }, { 66, 71 },
        { 89, 71 }, { 107, 71 } };
    ...
    public void onCraftMatrixChanged(IInventory inventory) {
        ...
        ItemStack result = craftMatrix.result == null ? null
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotId == OUTPUT) {
                ...
                for (int i = 0; i < OUTPUT; ++i) {
                    ...
                    if (item instanceof ILightsaberComponent
                        && ((ILightsaberComponent) item).isCompatibleSlot(itemstack, i)) {
                ...
                if (flag) {
                    ...
                    } else if (slotId >= OUTPUT + 28 && slotId < OUTPUT + 37
                        && !mergeItemStack(itemstack1, OUTPUT + 1, OUTPUT + 28, false)) {
                            return null;
                        }
                }
    ...
    private class Input extends Slot {
        ...
        public boolean isItemValid(ItemStack itemstack) {
            ...
            if (!(item instanceof ILightsaberComponent)
                || !((ILightsaberComponent) item).isCompatibleSlot(itemstack, getSlotIndex())) {
            ...
            for (int slot = 0; slot < inventory.getSizeInventory(); ++slot) {
                ...
                if (stack != null && stack.getItem() == item
                    && (stack.isItemStackDamageable() || stack.getItemDamage() == itemstack.getItemDamage())) {
                    return false;
                }
            }
    ...
    private class Output extends Slot {
        ...
        public void onPickupFromSlot(EntityPlayer player, ItemStack itemstack) {
            FMLCommonHandler.instance()
                .firePlayerCraftingEvent(player, itemstack, craftMatrix);
