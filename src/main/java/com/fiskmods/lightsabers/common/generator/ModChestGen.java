...
public class ModChestGen {
    ...
    public static void register() {
        addInfo(
            SITH_TOMB_ANNEX,
            new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.bone, 0, 4, 6, 4),
                new WeightedRandomChestContent(Items.rotten_flesh, 0, 3, 7, 3),
                new WeightedRandomChestContent(Items.iron_ingot, 0, 2, 7, 3),
                new WeightedRandomChestContent(ModItems.circuitry, 0, 1, 1, 2),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
        ...
        addInfo(
            SITH_TOMB_TREASURY,
            new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.bone, 0, 4, 6, 14),
                ...
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2),
                ...
                createColorCrystal(Item.getItemFromBlock(ModBlocks.lightsaberCrystal), 0, 1, 1, 4, SITH_TOMB_TREASURY),
                createColorCrystal(
                    Item.getItemFromBlock(ModBlocks.lightsaberCrystal),
                    0,
                    1,
                    1,
                    4,
        ...
        addInfo(
            ...
            new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.bone, 0, 4, 6, 14),
                ...
                new WeightedRandomChestContent(Items.diamond, 0, 1, 2, 5),
                new WeightedRandomChestContent(Items.enchanted_book, 0, 1, 1, 5),
                new WeightedRandomChestContent(ModItems.circuitry, 0, 1, 1, 3),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.focusingCrystal, 0, 1, 1, 1),
        ...
        addInfo(
            JEDI_TEMPLE,
            new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.cooked_chicken, 0, 1, 4, 4),
                ...
                new WeightedRandomChestContent(ModItems.circuitry, 0, 1, 2, 3),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
                new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 1),
        ...
        for (Map.Entry<CrystalColor, String[]> e : ItemCrystal.chestMap.entrySet()) {
            for (String chest : e.getValue()) {
                if (!chest.equals(SITH_TOMB_ANNEX) && !chest.equals(SITH_TOMB_TREASURY)
                    && !chest.equals(SITH_TOMB_COFFIN)) {
                    ChestGenHooks.addItem(
                        chest,
                        createColorCrystal(Item.getItemFromBlock(ModBlocks.lightsaberCrystal), 0, 1, 1, 1, chest));
                }
            }
        }

        ChestGenHooks
            .addItem(ChestGenHooks.VILLAGE_BLACKSMITH, new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2));
        ChestGenHooks
            .addItem(ChestGenHooks.VILLAGE_BLACKSMITH, new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2));
        ChestGenHooks
            .addItem(ChestGenHooks.VILLAGE_BLACKSMITH, new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2));
        ChestGenHooks
            .addItem(ChestGenHooks.DUNGEON_CHEST, new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2));
        ChestGenHooks
            .addItem(ChestGenHooks.DUNGEON_CHEST, new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2));
        ChestGenHooks
            .addItem(ChestGenHooks.DUNGEON_CHEST, new WeightedRandomChestContent(ModItems.emitter, 0, 1, 1, 2));
    ...
    private static WeightedRandomChestContent createSithLightsaber(Item item, int metadata, int min, int max,
        int weight) {
        ...
        chest.theItemId.getTagCompound()
            .setBoolean("SithTombLoot", true);
        return chest;
    }

    private static WeightedRandomChestContent createJediLightsaber(Item item, int metadata, int min, int max,
        int weight) {
        WeightedRandomChestContent chest = new WeightedRandomChestContent(item, metadata, min, max, weight);
        chest.theItemId.setTagCompound(new NBTTagCompound());
        chest.theItemId.getTagCompound()
            .setBoolean("JediTempleLoot", true);
        return chest;
    }

    private static WeightedRandomChestContent createColorCrystal(Item item, int metadata, int min, int max, int weight,
        String category) {
        WeightedRandomChestContent chest = new WeightedRandomChestContent(item, metadata, min, max, weight);
        chest.theItemId.setTagCompound(new NBTTagCompound());
        chest.theItemId.getTagCompound()
            .setString("ChestGenCategory", category);
        return chest;
    }
}
