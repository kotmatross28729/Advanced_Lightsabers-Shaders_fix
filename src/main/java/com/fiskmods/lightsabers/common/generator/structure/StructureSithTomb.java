...
public class StructureSithTomb extends Structure {
    ...
    private void generateEntrance(Random random) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            setBlock(
                i == 0 || i == 4 ? ModBlocks.darkForcestoneStairs : ModBlocks.forcestoneSlab,
                i == 0 ? 4 : (i == 4 ? 5 : 1),
                2 - i,
                i == 0 || i == 4 ? 4 : 5,
                1);
    ...
    private void generateAnnex(Random random) {
            ...
            for (int j = 0; j < 7; ++j) {
                for (int k = 0; k < 9; ++k) {
                    if (j == 6) {
                        ...
                        setBlock(
                            i == 0 || i == 14 || j == 0 || j == 5 || k == 0 || k == 8 ? ModBlocks.darkForcestone
                                : Blocks.air,
                            j == 2 ? 1 : 0,
                            i - 9,
                            j - 1,
        ...
        for (int i = 0; i < 5; ++i) {
            for (int j = 0; j < 5; ++j) {
                for (int k = 0; k < 2; ++k) {
                    setBlock(
                        i == 0 || i == 4 || j == 0 || j == 4 ? ModBlocks.darkForcestone : Blocks.air,
                        0,
                        2 - i,
                        j - 1,
                        k + 1);
        ...
        for (int i = 0; i < 13; ++i) {
            for (int j = 0; j < 7; ++j) {
                if (i == 0 || i == 12 || j == 0 || j == 6) {
                    ...
                    setBlock(
                        i == 0 || i == 12 || j == 0 || j == 6 ? ModBlocks.darkForcestoneStairs : Blocks.air,
                        k,
                        i - 8,
                        0,
                        3 + j);
        ...
        for (int i = 0; i < 11; ++i) {
            for (int j = 0; j < 5; ++j) {
                if (i == 0 || i == 10 || j == 0 || j == 4) {
                    ...
                    setBlock(
                        i == 0 || i == 10 || j == 0 || j == 4 ? ModBlocks.darkForcestoneStairs : Blocks.air,
                        k - 4,
                        i - 7,
                        4,
                        4 + j);
        ...
        for (int i = 0; i < 9; ++i) {
            for (int j = 0; j < 3; ++j) {
                if (i == 0 || i == 8 || j == 0 || j == 2) {
                    ...
                    setBlock(
                        i == 0 || i == 8 || j == 0 || j == 2 ? ModBlocks.darkForcestoneStairs : Blocks.air,
                        k - 4,
                        i - 6,
                        4,
                        5 + j);
        ...
        generateStructureChestContents(
            ...
            0,
            6,
            ChestGenHooks.getItems(SITH_TOMB_ANNEX, random),
            ChestGenHooks.getCount(SITH_TOMB_ANNEX, random));
        generateStructureChestContents(
            random,
            -8,
            0,
    ...
    private void generateBurialChamber(Random random) {
        ...
        for (int i = 0; i < 19; ++i) {
            for (int j = 0; j < 7; ++j) {
                for (int k = 0; k < 13; ++k) {
                    setBlock(
                        i == 0 || i == 18 || j == 0 || j == 6 || k == 0 || k == 12 ? ModBlocks.darkForcestone
                            : Blocks.air,
                        j == 2 ? 1 : 0,
                        -i - 2,
                        j - 1,
        ...
        for (int i = 0; i < 17; ++i) {
            for (int j = 0; j < 11; ++j) {
                if (i == 0 || i == 16 || j == 0 || j == 10) {
                    ...
                    setBlock(
                        i == 0 || i == 16 || j == 0 || j == 10 ? ModBlocks.darkForcestoneStairs : Blocks.air,
                        k,
                        -i - 3,
                        0,
                        5 - j);
        ...
        for (int i = 0; i < 7; ++i) {
            for (int j = 0; j < 5; ++j) {
                if (i == 0 || i == 6 || j == 0 || j == 4) {
                    ...
                    setBlock(
                        i == 0 || i == 6 || j == 0 || j == 4 ? ModBlocks.darkForcestoneStairs : Blocks.air,
                        k,
                        -i - 5,
                        -1,
                        2 - j);
        ...
        for (int i = 0; i < 12; ++i) {
            for (int j = 0; j < 7; ++j) {
                if (i == 0 || i == 11 || j == 0 || j == 6) {
                    ...
                    setBlock(
                        i == 0 || i == 11 || j == 0 || j == 6 ? ModBlocks.darkForcestoneStairs : Blocks.air,
                        k + 4,
                        -i - 6,
                        5,
                        3 - j);
        ...
        fillStructureInventory(
            ModBlocks.sithCoffin,
            random,
            -15,
            1,
            0,
            ChestGenHooks.getItems(SITH_TOMB_COFFIN, random),
            ChestGenHooks.getCount(SITH_TOMB_COFFIN, random));
    ...
    private void generateTreasury(Random random) {
        ...
        generateStructureChestContents(
            ...
            0,
            -10,
            ChestGenHooks.getItems(SITH_TOMB_TREASURY, random),
            ChestGenHooks.getCount(SITH_TOMB_TREASURY, random));
        generateStructureChestContents(
            random,
            3,
            0,
    ...
    private void generateCoffin(int x, int y, int z, int rotation, int coffinX, int coffinY, int coffinZ) {
        ...
        TileEntitySithStoneCoffin tile = (TileEntitySithStoneCoffin) worldObj
            .getTileEntity(xCoord + x, yCoord + y, zCoord + z);
        TileEntitySithCoffin tile1 = (TileEntitySithCoffin) worldObj
            .getTileEntity(xCoord + coffinX, yCoord + coffinY, zCoord + coffinZ);
