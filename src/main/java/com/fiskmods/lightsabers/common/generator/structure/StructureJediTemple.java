...
public class StructureJediTemple extends Structure {
    ...
    public void placeBlock(int x, int y, int z, Block block, int metadata, int flags) {
        if (ruination > 0) {
            ...
            } else if (block == Blocks.water || block == Blocks.stained_hardened_clay
                || block.hasTileEntity(metadata)
                || rand.nextFloat() * 4 >= ruination * ruination) {
    ...
    public void spawnStructure(Random random) {
        ...
        for (int layer = 0; layer < 2; ++layer) {
            ...
            for (int i = 0; i < 7; ++i) {
                setBlock(
                    i % 2 == 0 ? ModBlocks.lightForcestone : Blocks.stained_hardened_clay,
                    i % 2 == 0 ? 0 : 3,
                    5,
                    0,
                    14 + i);
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int j = 0; j < 5; ++j) {
                    if (j == 4) {
                        ...
                        setBlock(
                            i == 2 || i == 3 ? Blocks.planks : ModBlocks.lightForcestone,
                            i == 2 || i == 3 ? 4 : 0,
                            5,
                            i,
                            24 + j);
            ...
            for (int i = 0; i < 9; ++i) {
                ...
                setBlock(
                    i < 3 || i > 5 ? ModBlocks.lightForcestone : Blocks.stained_hardened_clay,
                    i < 3 || i > 5 ? 0 : 3,
                    4,
                    0,
                    13 + i);
                ...
                setBlock(
                    i == 8 ? ModBlocks.lightForcestoneStairs
                        : (i > 4 && i < 8 ? ModBlocks.lightActivatedForcestone : ModBlocks.lightForcestone),
                    i == 8 ? 2 : 0,
                    6,
                    i,
                    29);
            ...
            for (int i = 0; i < 11; ++i) {
                setBlock(
                    i < 2 || i > 8 || i == 5 ? ModBlocks.lightForcestone : Blocks.stained_hardened_clay,
                    i < 2 || i > 8 || i == 5 ? 0 : 3,
                    3,
                    0,
                    12 + i);
            ...
            for (int i = 0; i < 12; ++i) {
                ...
                setBlock(
                    i < 2 || i > 3 ? ModBlocks.lightForcestone : Blocks.stained_hardened_clay,
                    i < 2 || i > 3 ? 0 : 3,
                    2,
                    0,
                    11 + i);
            ...
            for (int i = 0; i < 13; ++i) {
                setBlock(
                    (i < 1 || i > 2) && i != 5 ? ModBlocks.lightForcestone : Blocks.stained_hardened_clay,
                    (i < 1 || i > 2) && i != 5 ? 0 : 3,
                    1,
                    0,
                    11 + i);
                setBlock(
                    i == 0 || i == 12 ? ModBlocks.lightForcestone : Blocks.stained_hardened_clay,
                    i == 0 || i == 12 ? 0 : 3,
                    0,
                    0,
                    11 + i);
            ...
            for (int i = 0; i < 28; ++i) {
                ...
                setBlock(
                    i == 0 || i == 27 ? ModBlocks.lightForcestone : ModBlocks.lightActivatedForcestone,
                    i == 0 || i == 27 ? 0 : 8,
                    0,
                    12,
                    7 + i);
                setBlock(
                    i == 0 || i == 27 ? ModBlocks.lightForcestone : ModBlocks.lightForcestoneStairs,
                    i == 0 || i == 27 ? 0 : 4,
                    1,
                    9,
                    7 + i);
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                for (int j = 0; j < 5; ++j) {
                    ...
                    setBlock(
                        i > 0 || j == 0 || j == 4 ? ModBlocks.lightForcestone : ModBlocks.lightForcestoneStairs,
                        i > 0 || j == 0 || j == 4 ? 0 : 7,
                        10 + j,
                        9 + i,
                        13);
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                setBlock(
                    i == 3 ? ModBlocks.lightForcestoneStairs : ModBlocks.lightActivatedForcestone,
                    i == 3 ? 1 : 0,
                    15,
                    5 + i,
                    8);
            ...
            for (int i = 0; i < 5; ++i) {
                ...
                setBlock(
                    i == 0 || i > 3 ? ModBlocks.lightForcestone : ModBlocks.lightActivatedForcestone,
                    0,
                    11,
                    i,
                    12);
                ...
                setBlock(
                    i == 0 || i == 4 ? ModBlocks.lightForcestone : ModBlocks.lightActivatedForcestone,
                    i == 0 || i == 4 ? 0 : 8,
                    0,
                    12,
                    24 + i);
                ...
                for (int j = 0; j < 3; ++j) {
                    setBlock(
                        j > 0 || i == 0 || i == 4 ? ModBlocks.lightForcestone : ModBlocks.lightForcestoneStairs,
                        j > 0 || i == 0 || i == 4 ? 0 : 4,
                        1,
                        9 + j,
                        24 + i);
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int j = 0; j < 4; ++j) {
                    if (j > 0 || i > 4) {
                        block = i < 2 ? ModBlocks.lightForcestone
                            : (i < 4 || i == 6 ? Blocks.stained_glass : ModBlocks.lightForcestone);
            ...
            /**
             * Congrats! You just found an easter egg in the code. [~o~] Redeem this token at twitter.com/FiskFille for
             * a prize, a shoutout and (if in a good mood) a pat on the back.
             */
            ...
            if (simulate) {
                for (int i = 0; i < coverage.size(); ++i) {
                    ...
                    int clearance = maxY + 8
                        - (int) (8 * random.nextDouble() * random.nextDouble() * random.nextDouble());

                    while (y > 0 && !worldObj.getBlock(p.posX, y - 1, p.posZ)
                        .isSideSolid(worldObj, p.posX, y - 1, p.posZ, ForgeDirection.UP)) {
                ...
                generateStructureChestContents(
                    random,
                    (int) (6 * ((random.nextFloat() - 0.5F) * 2)),
                    -1,
                    11 + random.nextInt(12),
                    ChestGenHooks.getItems(JEDI_TEMPLE, random),
                    ChestGenHooks.getCount(JEDI_TEMPLE, random));
            }
        }
    }
    ...
    public void generateTree(Random random) {
        ...
        for (int i = 0; i < MathHelper.getRandomIntegerInRange(random, 18, 20); ++i) {
            ...
            for (int j = 0; j < (MathHelper.getRandomIntegerInRange(random, branchMin, branchMax)
                + MathHelper.getRandomIntegerInRange(random, branchMin, branchMax)) / 2; ++j) {
                ...
                setBlock(
                    ...
                    1 + height + MathHelper.floor_double(vec3.yCoord),
                    ...
                    for (int y = -leafCoverageI; y <= leafCoverageI; ++y) {
                        for (int z = -leafCoverageI; z <= leafCoverageI; ++z) {
                            Block block = worldObj.getBlock(
                                xCoord + MathHelper.floor_double(vec3.xCoord) + x,
                                yCoord + 1 + height + MathHelper.floor_double(vec3.yCoord) + y,
                                zCoord + MathHelper.floor_double(vec3.zCoord) + z);

                            if (block != Blocks.log) {
                                Vec3 src = Vec3.createVectorHelper(
                                    MathHelper.floor_double(vec3.xCoord) + 0.5F,
                                    1 + height + MathHelper.floor_double(vec3.yCoord) + 0.5F,
                                    MathHelper.floor_double(vec3.zCoord) + 0.5F);
                                ...
                                if (src.distanceTo(dst) <= leafCoverage) {
                                    setBlock(
                                        Blocks.leaves,
                                        0,
                                        MathHelper.floor_double(vec3.xCoord) + x,
                                        1 + height + MathHelper.floor_double(vec3.yCoord) + y,
                                        MathHelper.floor_double(vec3.zCoord) + z);
                                }
                            }
                        }
                    }
