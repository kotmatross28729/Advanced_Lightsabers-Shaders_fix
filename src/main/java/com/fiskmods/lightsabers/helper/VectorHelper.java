...
// {
// public static Vec3 getOffsetCoords(EntityLivingBase entity, double xOffset, double yOffset, double zOffset, float
// partialTicks)
// {
// Vec3 vec3 = Vec3.createVectorHelper(xOffset, yOffset, zOffset);
// vec3.rotateAroundX(-(entity.rotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks) *
// (float) Math.PI / 180.0F);
// vec3.rotateAroundY(-(entity.rotationYaw - (entity.rotationYaw - entity.prevRotationYaw) * partialTicks) * (float)
// Math.PI / 180.0F);
//
// return Vec3.createVectorHelper(entity.posX + vec3.xCoord, getAccuratePlayerY(entity) + vec3.yCoord, entity.posZ +
// vec3.zCoord);
// }
//
...
// }
//
// public static Vec3 getBackSideCoords(EntityLivingBase entity, double amount, boolean side, double backAmount, boolean
// pitch)
// {
// Vec3 front = getFrontCoords(entity, backAmount, pitch).addVector(-entity.posX, -getAccuratePlayerY(entity),
// -entity.posZ);
// return getSideCoords(entity, amount, side).addVector(front.xCoord, front.yCoord, front.zCoord);
// }
//
// public static Vec3 getAboveBackSideCoords(EntityLivingBase entity, double amount, boolean side, double backAmount,
// boolean pitch, double aboveAmount)
// {
// Vec3 front = getBackSideCoords(entity, amount, side, backAmount, pitch).addVector(-entity.posX,
// -(getAccuratePlayerY(entity)), -entity.posZ);
...
// float xScale = f4 * f5;
// float zScale = f3 * f5;
// return Vec3.createVectorHelper(entity.posX, getAccuratePlayerY(entity), entity.posZ).addVector(xScale * amount,
// yScale * amount, zScale * amount);
// }
//
...
// }
//
// public static MovingObjectPosition rayTraceBlocks(World world, EntityLivingBase entity, double distance, boolean
// flag)
// {
...
// }
//
// public static Vec3 getBackSideCoordsRenderYawOffset(EntityLivingBase entity, double amount, boolean side, double
// backAmount, boolean pitch)
// {
// Vec3 front = getFrontCoordsRenderYawOffset(entity, backAmount, pitch).addVector(-entity.posX,
// -getAccuratePlayerY(entity), -entity.posZ);
...
// {
// return (entity.posY + (entity instanceof EntityPlayer && Lightsabers.proxy.isClientPlayer((EntityPlayer)entity) ? 0 :
// -0.2)) + entity.getEyeHeight();
// }
//
// public static List<EntityLivingBase> getEntitiesNear(World world, double x, double y, double z, double amount)
// {
// return world.selectEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(x - amount, y - amount, z
// - amount, x + amount, y + amount, z + amount), IEntitySelector.selectAnything);
// }
// }
