...
public class GuiALModConfig extends GuiConfig {
    ...
    private static IConfigElement categoryElement(String category, String name, String tooltip_key,
        IConfigElement... configElements) {
        List<IConfigElement> list = new ConfigElement(
            ModConfig.configFile.getCategory(category.toLowerCase(Locale.ROOT))).getChildElements();
