...
public abstract class HiltRenderer extends FiskRegistryEntry<HiltRenderer> {
    ...
    public static final FiskSimpleRegistry<HiltRenderer> REGISTRY = new FiskSimpleRegistry(
        Lightsabers.MODID,
        "graflex");
    ...
    public ResourceLocation getTexture(PartType type) {
        return new ResourceLocation(
            getDomain(),
            String
                .format("textures/models/lightsaber/%s_%s.png", type.textureName, getRegistryName().getResourcePath()));
    }
