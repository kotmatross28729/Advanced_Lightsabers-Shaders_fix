...
public class RenderLightsaber extends Render {
    ...
    public void render(EntityLightsaber entity, double x, double y, double z, float f, float partialTicks) {
        ...
        GL11.glRotatef(
            entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * partialTicks - 90,
            0,
            1,
            0);
        GL11.glRotatef(
    ...
    public void renderLightsaber(EntityLightsaber entity, double x, double y, double z, float spin,
        float partialTicks) {
