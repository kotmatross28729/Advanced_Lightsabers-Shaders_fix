...
public class ALParticles {
    ...
    public static EntityFX spawnParticle(ALParticleType particleType, double x, double y, double z, double motionX,
        ...
        if (mc != null && mc.renderViewEntity != null && mc.effectRenderer != null && mc.theWorld != null) {
            if (mc.theWorld.isRemote) {
                ...
                if (diffX * diffX + diffY * diffY + diffZ * diffZ > maxRenderDistance * maxRenderDistance && flag) {
                    ...
                    try {
                        Constructor c = particleType.particleClass.getConstructor(
                            World.class,
                            double.class,
                            double.class,
                            double.class,
